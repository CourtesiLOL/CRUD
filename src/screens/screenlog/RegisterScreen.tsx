...
import { Alert, View, TextInput, TouchableOpacity, Text, Image } from 'react-native';
...
function LogScreen(): JSX.Element {
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            >
                <Text style={registerScreenStyles.title}>CRUD</Text>
                <TextInput
                ...
                />
                <TouchableOpacity
                    style={[registerScreenStyles.button, { backgroundColor: '#1aa3ff' }]}
                    onPress={registrarse}
                >
